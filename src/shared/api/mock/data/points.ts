 ...
 * 체험 신청, 리뷰 작성 등의 활동에 따라 포인트가 변동됩니다.
 */
...
export const mockPointTransactions: PointTransaction[] = [
  // kakao-1001 (박민수) 포인트 내역
  {
    ...
    description: '신제품 커피 체험단 모집 체험 신청',
    campaignId: '1',
    balance: 1000,
  ...
  },
  {
    ...
    amount: 800,
    reason: 'campaign_application',
    description: '건강 보조 식품 체험단 체험 신청',
    campaignId: '4',
    balance: 1800,
  ...
  // kakao-1002 (최지영) 포인트 내역
  {
    ...
    amount: 1500,
    reason: 'campaign_application',
    description: '프리미엄 화장품 리뷰어 모집 체험 신청',
    campaignId: '2',
    balance: 1500,
  ...
  },
  {
    ...
    amount: 700,
    reason: 'campaign_application',
    description: '프리미엄 요거트 체험단 체험 신청',
    campaignId: '10',
    balance: 3900,
  ...
  },
  {
    ...
    amount: 1800,
    reason: 'campaign_application',
    description: '스마트 홈 기기 체험단 체험 신청',
    campaignId: '9',
    balance: 3600,
