...
): Array<{ day: string; startTime?: string; endTime?: string; isClosed: boolean }> | null {
  const dayHours: Array<{ day: string; startTime?: string; endTime?: string; isClosed: boolean }> =
    [];

  businessHours.forEach((hours, dayIndex) => {
    if (hours === 'closed') {
      dayHours.push({
